...
class KundalikApp:
    ...
    def _build_ui(self) -> None:
        ...
        button_row.grid(row=3, column=0, columnspan=6, sticky="w")
        ...
        columns = ("date", "project", "hours", "task")
        ...
        self.table.column("task", width=470)
    ...
    def _refresh_table(self) -> None:
        ...
        for idx, entry in enumerate(self.entries):
            self.table.insert(
                ...
                "end",
                iid=str(idx),
                values=(entry["date"], entry["project"], entry["hours"], entry["task"]),
            )
